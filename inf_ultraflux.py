...
prompts = [
    "An anime-style celestial swordswoman standing atop a luminous crescent moon, her flowing silver cloak scattering stardust across the night sky. Ethereal butterflies made of nebula light gather around her blade, which hums with cosmic energy. The scene mixes soft watercolor gradients with sharp action streaks for a surreal, dreamlike atmosphere.",

    "A high-speed anime motorcycle chase through a neon-drenched cyberpunk city, with holographic billboards casting shifting colors across rain-slick streets. The heroine’s luminous visor reflects incoming drones, while sparks trail from her anti-gravity wheels. Dynamic motion blur and bold cel-shading heighten the sense of velocity.",

    "An ancient shrine maiden channeling a colossal fox spirit, her red-and-white garments spiraling upward as the spectral beast materializes behind her. Patches of glowing sakura petals swirl through the air, illuminated by enchanted lanterns. The composition combines traditional ink-brush textures with modern anime lighting.",

    "A group of anime sky-pirates battling atop floating airships, with swirling clouds and lightning storms framing the chaotic duel. Steam vents burst from copper engines, and magical cannons fire iridescent projectiles. The characters’ exaggerated expressions and dynamic poses evoke classic shounen energy.",

    "A serene anime alchemist girl tending to a floating garden of bioluminescent plants, each leaf emitting pastel sparkles. Glass vials hover around her, rotating in a gentle orbit as runes glow beneath her feet. Soft painterly strokes blend with crystalline highlights for a gentle, luminous mood.",

    "A dragon-riding anime knight diving through volcanic plumes, the molten glow reflecting off the dragon’s obsidian scales. The knight’s cape snaps violently in the turbulence as geysers of fire erupt below. Dramatic backlighting and sharp color contrasts emphasize the explosive tension.",

    "An anime hacker girl floating in a virtual data dimension, surrounded by shifting polygons, luminous code streams, and glitchy holographic beasts. Her fingertips emit electromagnetic arcs that reshape the digital world around her. The scene merges vaporwave palettes with angular cel-shaded effects.",

    "A battle-worn anime samurai standing in a field of glowing spirit grass, his katana dripping with spectral energy as ghostly silhouettes rise from the mist. The moon above fractures into mirrored shards, each reflecting fragments of the battlefield. Mixes moody cinematic shadows with elegant brush-line motion.",

    "An anime magical engineer assembling a colossal gear-powered golem inside a floating workshop above the clouds. Ribbons of aurora light weave through rotating machinery, while tiny familiars carry glowing blueprints. Warm rim-lighting and whimsical mechanical details create a fantastical atmosphere.",

    "A cosmic anime idol performing on a zero-gravity stage surrounded by swirling galaxies, her holographic ribbons orbiting like planetary rings. Pulses of neon sound waves burst from her microphone, shaping vibrant star patterns. The scene blends soft pastel nebulae with crisp cel-shaded highlights for dreamy sci-fi energy."
]
